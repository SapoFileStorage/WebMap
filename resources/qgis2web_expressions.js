...
function exp_Stradeoggettodiintervento_3rule0_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('Sezione')  == 'Tipologia 1');
    } else {
        return (feature.get('Sezione')  == 'Tipologia 1');
    }
}
...
function exp_Stradeoggettodiintervento_3rule1_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('Sezione')  == 'Tipologia 2');
    } else {
        return (feature.get('Sezione')  == 'Tipologia 2');
    }
}
...
function exp_Stradeoggettodiintervento_3rule2_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('Sezione')  == 'Tipologia 3');
    } else {
        return (feature.get('Sezione')  == 'Tipologia 3');
    }
}
...
function exp_Stradeoggettodiintervento_3rule3_eval_expression(context) {
    ...
    if (feature.properties) {
        return (feature.get('Sezione')  == 'Tipologia 4');
    } else {
        return (feature.get('Sezione')  == 'Tipologia 4');
    }
}
...
function exp_Provincie_4rule0_eval_expression(context) {
    // SIGLA = 'PV'

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('SIGLA')  == 'PV');
    } else {
        return (feature.get('SIGLA')  == 'PV');
    }
}